...
for edge in edges:
    ...
    if(abs(y_values[0] - y_values[1]) < 0.0001):
...
plt.savefig('distance_kagome.png', transparent = True)
plt.show()

image_path = 'distance_kagome.png'
image = Image.open(image_path)
bbox = image.getbbox()
cropped_image = image.crop(bbox)
cropped_image_path = 'distance_kagome_cropped.png'
